...
def mappa_pagina2():
    return [
        ...
        # Fila delle caselle del quadro A. Il modello aggiornato al 20 ottobre 2025 ne ha
        # nove: rispetto alla versione precedente si aggiunge "Agevolazioni" in quinta
        # posizione, e le quattro successive scalano tutte di un posto. Le caselle sono
        # equidistanti di 50,4 punti.
        ("pagamento_intera_durata", 121.7, 614.7),
        ("eventi_eccezionali", 172.1, 614.4),
        ("casi_particolari", 222.5, 614.4),
        ("esenzioni", 272.9, 614.4),
        ("agevolazioni", 323.3, 614.4),
        ("contratto_tempo_indeterminato", 373.7, 614.4),
        ("clausola_penale_volontaria", 424.1, 614.4),
        ("tipo_garanzie_pac", 474.5, 614.4),
        ("garanzia_soggetta_iva", 524.9, 614.4),
