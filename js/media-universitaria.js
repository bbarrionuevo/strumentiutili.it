    ...
    function renderTabella() {
      ...
      if (esami.length === 0) {
        ...
        esami.forEach(esame => {
          ...
          // Il nome è testo libero dell'utente: va neutralizzato prima di finire in innerHTML
          const nomeSicuro = esame.nome.replace(/[&<>"']/g, c => ({ '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' }[c]));
          let displayNome = esame.nome.trim() !== '' ? nomeSicuro : '<em>Esame senza nome</em>';
