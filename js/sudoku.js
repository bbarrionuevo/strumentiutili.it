...
// Funziona nel browser (window.Sudoku) e in Node.
(function (root, factory) {
  ...
  /** La data di oggi in Italia: lo stesso sudoku per tutti, anche all'estero. */
  ...
  /**
   * La serie di giorni di fila con almeno un sudoku del giorno risolto.
   * Conta solo il sudoku di oggi: rifare quelli dei giorni prima non
   * allunga la serie (se no basterebbe l'archivio).
   * @param {object} serie { ultima: 'AAAA-MM-GG', giorni, record, risolti }
   * @param {string} data  il giorno del sudoku appena risolto
  ...
  return {
    delGiorno: delGiorno, oggiInItalia: oggiInItalia, LIVELLI: Object.keys(LIVELLI), NOMI_LIVELLI: NOMI_LIVELLI,
    giornoPrima: giornoPrima, aggiornaSerie: aggiornaSerie, serieAttuale: serieAttuale,
