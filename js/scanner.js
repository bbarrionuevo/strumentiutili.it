...
(function () {
  ...
  async function initScanner() {
    ...
    // Lo scatto diretto usa un input dedicato: quello principale resta libero di aprire
    // galleria e file manager, che con l'attributo capture non sarebbero raggiungibili.
