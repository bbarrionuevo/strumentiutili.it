...
const faceService = {
  ...
  async detectFace(imageData) {
    ...
    // Distanza occhi-mento misurata lungo l'asse del viso: se la testa è inclinata, la
    // sola differenza di ordinate la sottostima e il volto verrebbe ingrandito troppo.
    const eyeToChinDistance = Math.hypot(chinPoint.x - avgEyeX, chinPoint.y - avgEyeY);

    // Inclinazione della linea degli occhi, in gradi: serve a raddrizzare il volto.
    const inclinazioneGradi = Math.atan2(
